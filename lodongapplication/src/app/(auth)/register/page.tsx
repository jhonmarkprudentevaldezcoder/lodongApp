                ...
                <form className="space-y-4 md:space-y-6" action="#">
                  <div>
                    ...
                    <input
                      ...
                      name="email"
                      id="email"
                      className="bg-gray-50 border border-none text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
